defmodule BubbleTeaWeb.GameLiveTest do
  use BubbleTeaWeb.ConnCase

  import Phoenix.LiveViewTest
  import BubbleTea.GamesFixtures

  @create_attrs %{name: "some name", over: true}
  @update_attrs %{name: "some updated name", over: false}
  @invalid_attrs %{name: nil, over: false}
